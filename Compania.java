...
{   
    ...
    /**
     * Ordena los aeropuertos según el procentaje de aprovechamiento de una compañía.
     * 
     */
    ...
    /**
     * Determina la existencia o no de un aeropuerto dentro de una compañía,
     * si la posición vendrá determinada desde 0-tamaño array,
     * el -1 indicará no existe.  
     */
    ...
    /**
     * Repetimos igual que en el método anterior, el -1 significará que no existe.
     */
    ...
    /**
     * Añade compañías al array, pero teniendo en cuenta que esas compañías no generan vuelos en entre esas fechas.
     */
    ...
    */
    public static void numeroAerolineas(){
        ...
        try{
           f= new Scanner(new File(Programa.getCompanias()));
        }
